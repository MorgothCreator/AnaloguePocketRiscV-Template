...
reg phy_spimiso_int;
reg phy_spiclk_int;
assign phy_spimosi = phy_spimosi_int;
assign phy_spimiso = phy_spimiso_int;
assign phy_spiclk = phy_spiclk_int;
//
...
always @(posedge clk) begin 
    ...
    ST_SIDLE: begin
        ...
        phy_spiclk_int <= 1'bZ;
        phy_spimosi_int <= 1'bZ;
        phy_spimiso_int <= 1'bZ;
    ...
    ST_SEND_N: begin
        phy_spiclk_int <= 1'b1;
        phy_spimosi_int <= 1'b1;
        phy_spimiso_int <= 1'b1;
        spis <= ST_SEND_0;  
    end
    // tx, shift out bits
    ST_SEND_0: begin        
        phy_spiclk_int <= 0;    
        spis <= ST_SEND_1;      
        phy_spimosi_int <= spis_word[31];
        phy_spimiso_int <= spis_word[30];
